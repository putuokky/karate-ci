...
$route['log/dojo(/:any)?'] = 'dojo$1';
$route['log/dojo/(:any)/(:num)'] = 'dojo/$1/$2';

$route['log/sabuk(/:any)?'] = 'sabuk$1';
$route['log/sabuk/(:any)/(:num)'] = 'sabuk/$1/$2';

$route['log/karateka(/:any)?'] = 'karateka$1';
$route['log/karateka/(:any)/(:num)'] = 'karateka/$1/$2';
